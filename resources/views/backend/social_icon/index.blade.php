...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Social-Icon
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('social.icon.index') }}" class="text-muted text-hover-primary">All-Social-Icon</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Social-Icon</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        {{-- add button  --}}
        <button data-bs-toggle="modal" data-bs-target="#socialIconCreateModal" class="btn btn-sm btn-success mb-2"><svg
...
<div class="modal fade" id="socialIconEditModal" tabindex="-1" aria-labelledby="socialIconEditModalLabel"
    aria-hidden="true">
...
@include('backend.social_icon.create')
<script>
    $(document).ready(function() {
        $('#featuredProjectTitleHeading').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('social.icon.getdata') }}',
            columns: [{
    ...
    $(document).on('click', '.edit', function() {
        ...
        $.ajax({
            url: '/social-icon/edit/' + dataId,
            type: 'GET',
            success: function(response) {
                $('#modalShow').html(response);
                $('#socialIconEditModal').modal('show');
